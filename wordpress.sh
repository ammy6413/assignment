...
cp -r ./wordpress /var/www/nginx/
chown -R www-data:www-data /var/www/nginx/wordpress/
chmod -R 755 /var/www/nginx/wordpress	
mkdir /var/www/nginx/wordpress/wp-content/uploads
mv /var/www/nginx/wordpress/wp-config-sample.php /var/www/nginx/wordpress/wp-config.php
sed -i -e 's/database_name_here/wordpress/g' /var/www/nginx/wordpress/wp-config.php
sed -i -e 's/username_here/wordpressuser/g' /var/www/nginx/wordpress/wp-config.php 
sed -i -e 's/password_here/password/g' /var/www/nginx/wordpress/wp-config.php
